/*
 * This module exports a stateful mint layout component
 * ============
 * @module quinoa-story-player/templates/mint
 */
...
import templateCss from '!raw-loader!sass-loader!./mint.scss';
 ...
 */
class MintLayout extends Component {
  /**
   * constructor
  ...
  render = () => {
    ...
    const computedStylesVariables = settings.styles
      ? stylesVariablesToCss(settings.styles.mint.stylesVariables)
      : '';
    ...
    const FinalNav = ({ placeholder }) => {
      if (previewMode) {
        return <NavEl placeholder={placeholder} />;
      }
      const ConnectedEl = withRouter(props => <NavEl {...props} />);
      return <HashRouter><ConnectedEl placeholder={placeholder} /></HashRouter>;
    };
