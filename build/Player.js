 ...
 */
var QuinoaStoryPlayer =
/*#__PURE__*/
function (_Component) {
  _inherits(QuinoaStoryPlayer, _Component);
  ...
  function QuinoaStoryPlayer(props) {
    ...
    _classCallCheck(this, QuinoaStoryPlayer);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(QuinoaStoryPlayer).call(this, props));
  ...
  _createClass(QuinoaStoryPlayer, [{
    key: "getChildContext",
    ...
    value: function renderComponent() {
      ...
      if (this.state.story && this.state.status === 'loaded') {
        ...
        return _react.default.createElement("div", null, "Oups, that looks like an error");
      } else {
        return _react.default.createElement("div", null, "No data yet");
      }
    }
    /**
    ...
    value: function render() {
      ...
      return _react.default.createElement(_reactMeasure.default, {
        ...
        }, _this2.renderComponent(), _react.default.createElement("div", {
          id: "modal-root"
        }));
      });
    }
...
var _default = QuinoaStoryPlayer;
