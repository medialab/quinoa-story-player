...
var templateInfo = [require('./templates/garlic/info'), require('./templates/pepper/info'), require('./templates/mint/info')]; // templates info are accessible as an array of objects
