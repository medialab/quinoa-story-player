...
var _mint = _interopRequireDefault(require("!raw-loader!sass-loader!./mint.scss"));
...
/**
 * MintLayout class for building a story-player template react component instances
 */

var MintLayout =
/*#__PURE__*/
function (_Component) {
  _inherits(MintLayout, _Component);

  /**
   * constructor
   * @param {object} props - properties given to instance at instanciation
   */
  function MintLayout(_props) {
    var _this;

    _classCallCheck(this, MintLayout);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MintLayout).call(this, _props));
    ...
    _this.render = function () {
      ...
      var computedStylesVariables = settings.styles ? (0, _utils.stylesVariablesToCss)(settings.styles.mint.stylesVariables) : '';
      /**
       * ==========================================
       * Callbacks
       * ==========================================
      ...
      var FinalNav = function FinalNav(_ref2) {
        var placeholder = _ref2.placeholder;

        if (previewMode) {
          return _react.default.createElement(NavEl, {
        ...
        return _react.default.createElement(_reactRouterDom.HashRouter, null, _react.default.createElement(ConnectedEl, {
          placeholder: placeholder
        }));
      };
      ...
      return _react.default.createElement(_reactCiteproc.ReferencesManager, {
        ...
        className: "wrapper"
      }, _react.default.createElement(FinalNav, {
        placeholder: true
      }), _react.default.createElement(FinalNav, null), _react.default.createElement(_reactCustomScrollbars.Scrollbars, {
        ...
        component: function component(_ref3) {
          var sectionId = _ref3.match.params.sectionId,
